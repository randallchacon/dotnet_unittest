...
namespace TestNinja.Mocking
{
    public class HousekeeperService
    {
        ...
        private IStatementGenerator _statementeGenerator;
            ...
            )
        {
            ...
            _statementeGenerator = statementGenerator;
        ...
        public void SendStatementEmails(DateTime statementDate)
        {
            ...
            foreach (var housekeeper in housekeepers)
            {
               ...
               var statementFilename = _statementeGenerator.SaveStatement(housekeeper.Oid, housekeeper.FullName, statementDate);
    ...
    public class _messageBox : IXtraMessageBox
    {
